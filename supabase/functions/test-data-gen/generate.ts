...
import { getSchemaHint, executeSql } from './sql-executor.ts';

// Use Haiku for speed — test data generation is simple SQL
...
export async function handleGenerate(req: Request): Promise<Response> {
  ...
  // Resolve admin user ID for test data templates
