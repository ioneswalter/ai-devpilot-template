          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center max-w-xs">
              <div className="relative w-16 h-16 mx-auto mb-4">
                <svg
                  className="animate-spin w-16 h-16 text-blue-200"
                  viewBox="0 0 24 24"
                  fill="none"
                >
                  <circle
                ...
                <svg
                  className="absolute inset-0 w-16 h-16 text-blue-500 p-4"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <h4 className="text-sm font-semibold text-gray-900 mb-1">
                Building implementation tasks...
              </h4>
              <p className="text-xs text-gray-500">
                Analyzing acceptance criteria, test cases, and project patterns. This may take 30-60
                seconds.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 space-y-3">
              ...
              <ol className="text-xs text-indigo-700 space-y-1 list-decimal list-inside">
                ...
                <li>
                  <strong>You review each task</strong> — accept, edit, or reject before execution
                </li>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <p className="text-xs text-gray-500 text-center">
                After running{' '}
                <CopyableCommand command={`\\build ${featureCode}`} className="bg-white" />, tasks
