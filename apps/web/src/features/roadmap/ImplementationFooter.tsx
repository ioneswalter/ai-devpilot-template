        ...
        <div className="flex items-center gap-2">
          ...
          {canImplement && !isImplementing && (
            ...
            >
              ...
              Implement
              {acceptedCount - implementedCount - failedImplCount > 0
          ...
          {isComplete && !codeApplied && !isImplementing && (
            <button
              ...
              title={
                complianceBlocked ? 'Resolve constitution violations before proceeding' : undefined
              }
...
function TaskCounts({
  ...
  ImplementationFooterProps,
  'canImplement' | 'isComplete' | 'codeApplied' | 'onImplement' | 'onWriteCode' | 'onClose'
>) {
    ...
    <div className="flex items-center gap-3 text-xs">
      ...
      {!isImplementing && hasImplProgress && (
        <>
          ...
          {failedImplCount > 0 && <span className="text-gray-400">{failedImplCount} skipped</span>}
          {remainingImplCount > 0 && (
            <span className="text-amber-600">
              {remainingImplCount} remaining — click Implement to process
            </span>
          )}
        </>
      )}
