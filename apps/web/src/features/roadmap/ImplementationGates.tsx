...
export function ReviewBlockingGate({ featureCode, featureTitle, isSentBack, onClose }: ReviewBlockingGateProps) {
  return (
    <div className="flex flex-col h-full">
      <GateHeader featureCode={featureCode} featureTitle={featureTitle} />
      <div className="px-4 py-3 border-b bg-amber-50 border-amber-200 flex items-center gap-3">
...
export function ManualImplGate({ featureCode, featureTitle, isRequesting, onStartAnyway, onClose }: ManualImplGateProps) {
  return (
    <div className="flex flex-col h-full">
      <GateHeader featureCode={featureCode} featureTitle={featureTitle} />
