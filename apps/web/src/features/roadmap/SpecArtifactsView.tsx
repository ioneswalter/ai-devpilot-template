...
export function SpecArtifactsView({
  featureId,
  onArtifactsLoaded,
  defaultCollapsed = false,
}: SpecArtifactsViewProps) {
        ...
        <div className={`space-y-1.5 ${collapsed ? 'hidden' : ''}`}>
          ...
          {expandedArtifact && (
            <div className="flex flex-wrap gap-1 mb-2">
              {sorted
                .filter((a) => a.id !== expandedArtifact)
                .map((art) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`px-1.5 py-0.5 text-xs font-medium rounded border ${meta.color}`}
                  >
                    {meta.label}
                  </span>
