...
export function ImplementationTaskCard({
  ...
  return (
    <div
      className={`border rounded-lg p-3 transition-colors ${decisionStyle.bg} ${isGenerating ? 'animate-pulse' : ''}`}
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mb-1 flex-wrap">
            <span
              className={`text-xs font-medium px-1.5 py-0.5 rounded ${typeStyle.bg} ${typeStyle.text}`}
            >
              {item.task_type}
            </span>
            <span
            ...
            {item.implementation_status !== 'pending' && (
              <span
                className={`text-xs font-medium px-1.5 py-0.5 rounded ${implStatus.bg} ${implStatus.text}`}
              >
                {isGenerating && (
            ...
            <div className="mt-2 pt-2 border-t space-y-2">
              ...
              <div className="flex gap-1.5">
                <input
                  ...
                  className="flex-1 text-xs border rounded px-2 py-1 focus:ring-1 focus:ring-blue-300"
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
